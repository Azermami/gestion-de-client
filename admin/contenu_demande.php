      ...
      <tbody>
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo '<td align="center"><button class="icon-button" onclick="afficherFormulaire('.$row['id_demande'].','."'".$row['etatc']."'".')">';
            echo '<img src="img/icons/aj.png" width="20px" height="20px"  alt="Ajouter" />';
            echo '</button></td>';
            echo "</tr>";
            $counter++;
          }
